var POWERMATE_VENDOR_ID = 1466; //0x05BA;
var POWERMATE_PRODUCT_ID = 10; //0x000A;
var DEVICE1_INFO = {"vendorId": POWERMATE_VENDOR_ID, "productId": POWERMATE_PRODUCT_ID};
var DEVICE2_INFO = {"vendorId": 3238, "productId": 16};
...
var gotPermission = function(result) {
    ...
    chrome.usb.findDevices( DEVICE1_INFO,
      function(devices) {
...
var permissionObj = {permissions: [{'usbDevices': [DEVICE1_INFO] }]};
var permissionObj2 = {permissions: [{'usbDevices': [DEVICE1_INFO] }]};

requestButton.addEventListener('click', function() {
  chrome.permissions.request( permissionObj2, function(result) {
    if (result) {
      gotPermission();
    } else {
